...
export default function UpdateUser() {
  return (
    <div className="flex justify-center items-center h-screen">
      <form className="bg-zinc-700 flex flex-col items-center justify-center w-[420px] h-[650px] rounded-xl max-sm:w-[360px] relative">
        <Link
          href="/configuration"
        ...
        <p className="text-xl mb-5">Editar perfil</p>
        <div className="">
